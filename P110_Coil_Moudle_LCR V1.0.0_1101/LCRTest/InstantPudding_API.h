...
#define IP_ATTRIBUTE_COIL_SN     "CoilSN"//coilSN
#define IP_ATTRIBUTE_UPPERFERRITE_SN    "upperFerriteSN"//upperFerriteSN
#define IP_ATTRIBUTE_LOWERFERRITE_SN   "lowerFerriteSN"//lowerFerriteSN
